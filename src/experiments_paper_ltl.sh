...
# No pretraining
python train_agent.py --algo ppo --env Letter-7x7-v3 --log-interval 1 --save-interval 20 --frames 10000000 --discount 0.94 --ltl-sampler Until_1_2_1_3 --epochs 4 --lr 0.0003 --seed ${seed} --dfa &> outputs/ltl_train_CompositionalReachAvoid_1_2_1_3_seed_${seed}.txt &
python train_agent.py --algo ppo --env Letter-7x7-v3 --log-interval 1 --save-interval 20 --frames 10000000 --discount 0.94 --ltl-sampler Eventually_1_4_1_3 --epochs 4 --lr 0.0003 --seed ${seed} &> outputs/ltl_train_CompositionalEventually_1_4_1_3_seed_${seed}.txt &

# Pretraining
python train_agent.py --algo ppo --env Simple-LTL-Env-v0 --log-interval 1 --save-interval 20 --frames-per-proc 512 --batch-size 1024 --frames 5000000 --dumb-ac --discount 0.9 --ltl-sampler Eventually_1_4_1_3_JOIN_Until_1_2_1_3 --lr 0.001 --clip-eps 0.1 --gae-lambda 0.5 --epochs 2 --seed ${seed} &> outputs/ltl_pretrain_RGCN_seed_${seed}.txt;
